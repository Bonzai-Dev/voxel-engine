  ...
  namespace Fibers {
    ...
    class waker_with_hook: public waker {
      public:
        ...
        friend bool operator==(waker const &lhs, waker const &rhs) noexcept {
          return &lhs == &rhs;
        }
    ...
    namespace detail {
      typedef intrusive::slist<
        waker_with_hook,
        intrusive::member_hook<waker_with_hook, detail::waker_queue_hook, &waker_with_hook::waker_queue_hook_>,
