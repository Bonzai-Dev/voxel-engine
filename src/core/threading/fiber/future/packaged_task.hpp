...
#include <core/threading/fiber/future/detail/task_base.hpp>
#include <core/threading/fiber/future/detail/task_object.hpp>
    ...
    class packaged_task<R(Args...)> {
      ...
      public:
        ...
        future<R> get_future() {
          ...
          obtained_ = true;
          return future<R>{
            Core::static_pointer_cast<detail::shared_state<R>>(task_)
          };
        }
