...
#include <core/threading/fiber/detail/cpu_relax.hpp>
#include <core/threading/fiber/detail/rtm.hpp>
#include <core/threading/fiber/detail/spinlock_status.hpp>
              ...
              if (rtm_status::none != (status & rtm_status::may_retry) ||
                ...
                if (BOOST_FIBERS_CONTENTION_WINDOW_THRESHOLD > collisions) {
                  std::uniform_int_distribution<std::size_t> distribution{
                    0,
                    static_cast<std::size_t>(1) << (std::min)(
                      collisions, static_cast<std::size_t>(BOOST_FIBERS_CONTENTION_WINDOW_THRESHOLD))
                  };
