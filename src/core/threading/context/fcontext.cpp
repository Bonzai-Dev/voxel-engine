...
extern "C"
Core::Context::detail::transfer_t BOOST_CONTEXT_CALLDECL jump_fcontext(Core::Context::detail::fcontext_t const to,
                                                                       void *vp);

extern "C"
Core::Context::detail::fcontext_t BOOST_CONTEXT_CALLDECL make_fcontext(void *sp, std::size_t size,
                                                                       void (*fn)(Core::Context::detail::transfer_t));

// based on an idea of Giovanni Derreta
extern "C"
Core::Context::detail::transfer_t BOOST_CONTEXT_CALLDECL ontop_fcontext(Core::Context::detail::fcontext_t const to,
                                                                        void *vp,
                                                                        Core::Context::detail::transfer_t (*fn)(
                                                                          Core::Context::detail::transfer_t));
