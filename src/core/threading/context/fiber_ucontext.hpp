...
namespace Core::Context {
  namespace detail {
    ...
    struct forced_unwind {
      ...
      forced_unwind(fiber_activation_record *from_) noexcept: from{from_} {
      }
    };
    ...
    class fiber_capture_record: public fiber_activation_record {
      ...
      public:
        fiber_capture_record(stack_context sctx, StackAlloc &&salloc, Fn &&fn) noexcept: fiber_activation_record
          {sctx},
