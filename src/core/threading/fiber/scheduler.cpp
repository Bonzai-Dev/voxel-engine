...
namespace Core {
  namespace Fibers {
    ...
    Core::Context::fiber scheduler::dispatch() noexcept {
    ...
    Core::Context::fiber scheduler::terminate(detail::spinlock_lock &lk, context *ctx) noexcept {
      ENGINE_ASSERT(nullptr != ctx, "");
    ...
    bool scheduler::wait_until(context *ctx,
    ...
    void scheduler::attach_dispatcher_context(RefCountedPtr<context> ctx) noexcept {
      ENGINE_ASSERT(ctx, "");
